        ...
        return (
          <div>
            <p style={{ fontFamily: FB, fontSize: 13, color: TEXT2, marginBottom: 16, lineHeight: 1.6 }}>
              Set the 3 Top Drivers and 7 Midfield Drivers available for each race week. Players pick 1 Top Driver and 4 Midfield Drivers.
            </p>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              >
                ...
                {races.map(r => {
                  const has = r.top_drivers && r.top_drivers.length > 0;
                  return (
                    <option key={r.round} value={r.round}>
                      Round {r.round} — {r.race_name} {has ? "✅" : ""}
                    </option>
                  );
                })}
              </select>
