...
const PAGES = new Set([
  ...
  "dashboard", "hands1", "hands2", "hands3", "hands4", "hands5", "hands6", "hands7", "home-v1", "schedule-v1", "team-standings", "team-standings-v1", "player-standings-v1", "division-trends", "players", "rules", "strategy",
...
const VEGAS_PAGES = new Set(["hands1", "hands2", "hands3", "hands4", "hands5", "hands6", "hands7", "home", "vegas", "dashboard", "schedule", "team-standings", "player-standings"]);
...
export default function App() {
  ...
  const ideaN = /^hands([1-7])$/.exec(activePage);
